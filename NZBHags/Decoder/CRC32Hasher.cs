...
namespace NZBHags
{
    ...
    {   
      ...
      private static byte[] getCheckSum(UInt32 checksum)
      {
      ...
      public static UInt32 Calculate(byte[] Value)
      {
          UInt32 checksum = 0xffffffff; 
          //checksum ^= 0xffffffff; // Toggle operation
          for (int i = 0; i < Value.Length; i++)
          {
              checksum = (checksum >> 8) ^ CRCTable[(checksum ^ Value[i]) & 0x000000ff];
          }
